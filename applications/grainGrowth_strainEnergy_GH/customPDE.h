...
private:
    ...
    double with_stored = userInputs.get_model_constant_double("with_stored");

    double G =userInputs.get_model_constant_double("G");
    double b =userInputs.get_model_constant_double("b");
    double gamma_gb =userInputs.get_model_constant_double("gamma_gb");
    double l0_const =userInputs.get_model_constant_double("l0_const");
    double l_int_unitless =userInputs.get_model_constant_double("l_int_unitless");
    double rho_mean =userInputs.get_model_constant_double("rho_mean");
    double m0_const = 6.0*gamma_gb/(l0_const*l_int_unitless); //same as W
    double fs_const = 0.5*G*b*b*rho_mean/m0_const;
    //double fs_const = 0.5*G*b*b*rho_mean*l0_const*l_int_unitless/(6.0*gamma_gb);
    ...
    double rho_i[64] = {0.69100, 0.95383, 0.73808, 1.11133,
        1.23228, 1.07623, 0.60829, 0.71991,
        1.15459, 0.50515, 1.21852, 0.57925,
        1.24893, 0.62968, 0.87087, 1.71599,
        0.42605, 0.79744, 1.41075, 0.97486,
        1.23228, 1.07623, 0.60829, 0.71991,
        1.15459, 0.50515, 1.21852, 0.57925,
        1.24893, 0.62968, 0.87087, 1.71599,
        0.42605, 0.79744, 1.41075, 0.97486,
