...
sign = phi/sqrt(phi*phi + 0.00001);

// LEVEL SET EQUATION
scalarvalueType eq_phi = phi + constV(userInputs.dtValue)*sign*(1.0 - sqrt(phix*phix));
scalargradType eqx_phi = (-constV(userInputs.dtValue*0.1)*phix);
