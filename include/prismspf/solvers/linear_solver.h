    ...
    try
      {
        ...
        cg_solver.solve(lhs_operator, x_vector, b_vector, chebyshev);
...
protected:
  ...
  initialize_chebyshev()
  {
    ...
    precond_data.degree = lin_params.smoother_degree precond_data.smoothing_range =
      lin_params.smoothing_range; // ≈ λ_min / λ_max
